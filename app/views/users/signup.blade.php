...
<div class="container">
	...
	<div class="omb_login">
		<h3 class="omb_authTitle">{{$title}}</h3>
			...
			<div class="col-xs-12 col-sm-6">
								...
								<form method="POST" action="{{{ URL::to('users') }}}"
									...
									<fieldset>
										...
										return Schema::hasColumn(Config::get('auth.table'),
										'username'); }))
										<div class="form-group">
											<label for="username">{{{Lang::get('confide::confide.username') }}}</label> <input
												class="form-control"
										...
										<div class="form-group">
											<label for="password">{{{Lang::get('confide::confide.password') }}}</label> <input
												class="form-control"
